...
@section('title', 'Kadar Air Produk Jadi')
...
<td rowspan="3" width="40%" class="title">
    CATATAN PEMERIKSAAN <br> KADAR AIR PRODUK JADI <br>
    <span class="small"><i>(Inspection Record of Water Content <br>Finished Product)</i></span>
</td>
