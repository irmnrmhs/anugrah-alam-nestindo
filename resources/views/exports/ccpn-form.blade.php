...
<td rowspan="3" width="40%" class="title">
    CATATAN PEMERIKSAAN <br> KADAR NITRIT SELAMA PROSES <br> (CCP 1)
    <span class="small"><i>(Inspection Record Nitrite Content <br> During Process (CCP 1)))</i></span>
</td>
...
@php
    $arrival = $ccpns->rawMaterial->arrivals->first();
@endphp
<tr>
