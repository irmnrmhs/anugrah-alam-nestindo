...
@php
    $title = 'Kelola Hasil Uji Aluminium Produk Jadi';
    $singular = 'Hasil Uji Aluminium Produk Jadi';
    $deleteMultipleUrl = '/fp-alums/delete-multiple';
    // $importUrl = route('fp-alums.import');
    // $templateUrl = route('fp-alums.template');
@endphp
