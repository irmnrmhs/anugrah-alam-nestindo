...
class AnalysisSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Analysis::create([
            'item' => 'Weight (g)',
            'standard' => '50.0 g(+0.30.5 g), 100.0 g (+0.7-0.9g), 250.0 g (+2.55.0 g), 450.0 g (0.10.5 g), 500.0 g (+5.0 10.0 g), 540.0 g (+0.1-0.5 g), 600.0 g (+0.1-0.5g), 720.0 g (+0.1-0.5 g), 800.0 g (+0.1-0.5 g), 900.0 g (+0.1-0.5g), 1000.0 g (+ 10.0-20.0 g)',
        ]);
