    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Customer',
                    'url'  => 'customers',
                    'can'  => ['Super Admin', 'MR', 'Admin Ekspor'],
                    'icon' => 'fas fa-users',
                ],
                [
                ...
                [
                    'text' => 'Mobil',
                    'url'  => 'cars',
                    'can'  => ['Super Admin', 'MR', 'Admin Rumah Walet', 'Admin Bahan Baku'],
                    'icon' => 'fas fa-users',
                ],
                [
                    'text' => 'Area',
                ...
                [
                    'text' => 'Jenis Bentuk',
                    'url'  => 'shapes',
                    'can'  => ['Super Admin', 'MR', 'Admin Bahan Baku'],
                    'icon' => 'fas fa-users',
                ],
                [
                    'text' => 'Jenis Bulu',
                ...
                [
                    'text' => 'Jenis Uji',
                    'url'  => 'testTypes',
                    'can'  => ['Super Admin', 'MR', 'Admin Kontrol Kualitas'],
                    'icon' => 'fas fa-users',
                ],
                [   'header' => 'Produksi' ],
                [
                    'text' => 'Tipe Sarang',
                    'url'  => 'nests',
                    'can'  => ['Super Admin', 'MR', 'Admin Produksi'],
                    'icon' => 'fas fa-users',
                ],
                [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'HU Nitrit Selama Proses',
                    'url'  => 'ccp1',
                    'can'  => ['Super Admin', 'MR', 'Admin Kontrol Kualitas'],
                    'icon' => 'fas fa-users',
                ],
                [
                    'text' => 'HU Al Selama Proses',
                    'url'  => 'ccp-al',
                    'can'  => ['Super Admin', 'MR', 'Admin Kontrol Kualitas'],
                    'icon' => 'fas fa-users',
                ],
                [
                    'text' => 'HU Air & Nitrit PJ',
                    'url'  => 'fp-results',
                    'can'  => ['Super Admin', 'MR', 'Admin Kontrol Kualitas'],
                    'icon' => 'fas fa-users',
                ],
