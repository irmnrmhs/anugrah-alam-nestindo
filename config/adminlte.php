        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Jenis Uji',
                    'url'  => 'testTypes',
                    'can'  => ['Super Admin', 'Admin Kontrol Kualitas (Lab)'],
                    'icon' => 'fas fa-users',
                ],
                [   'header' => 'Produksi' ],
                [
                    'text' => 'Tipe Sarang',
                    'url'  => 'nests',
                    'can'  => ['Super Admin', 'Admin Kontrol Kualitas (Data)'],
                    'icon' => 'fas fa-users',
                ],
                [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Packing List',
                    'url'  => 'packlist',
                    'can'  => ['Super Admin', 'Admin Kontrol Kualitas (Data)', 'Admin Keamanan Pangan'],
                    'icon' => 'fas fa-users',
                ],
                [
